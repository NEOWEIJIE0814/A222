...
class SellerDetailsScreen extends StatefulWidget {
  ...
  final User user;
  const SellerDetailsScreen({super.key,required this.usercatch, required this.user});
            ...
            child: Card(
              child: Container(
                ...
                child: CachedNetworkImage(
                  width: screenWidth,
                  fit: BoxFit.cover,
                  imageUrl: "${MyConfig().SERVER}/mynelayan/assets/catches/${widget.usercatch.catchId}.png",
        ...
        Expanded(child: Container(
          ...
          child: Table(
            ...
            children: [
              ...
              TableCell(child: Text( widget.usercatch.catchDesc.toString(),))
              ]),
              TableRow(children: [
                  const TableCell(
                    child: Text(
